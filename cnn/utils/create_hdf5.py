...
h5_file = h5py.File("/home/ramanha/dataset/traindata_cnn_dict/CSI1testfile.hdf5", "a", libver='latest')
...
csi3 = h5_file.create_group("CSI1")
...
for root, dire, files in os.walk(data_folder):
    for idx, fil in enumerate(files):
        ...
        #with h5py.File("/home/ramanha/dataset/traindata_cnn_dict/CSI1testfile.hdf5", "a") as h5_file:
            #print(f['X'].shape)
        datasetX[:,:,:,:] = f['X']
        datasetY[:] = f['y']
